...
export const fallbackProjects = [
  { title: 'Plasma', category: 'Music Video', audience: 'Music Videos', type: 'Reel', orientation: 'portrait', duration: '0:48', result: '3.1M views in the first two weeks', thumbnail: '/images/thumb_plasma.jpg', videoUrl: '/videos/plasma.webm' },
  { title: 'Cosmic Bloom', category: 'Generative Art', audience: 'Brand Films', type: 'Widescreen', orientation: 'landscape', duration: '1:32', result: 'Launch film — 1.2M reach', thumbnail: '/images/thumb_cosmic_bloom.jpg', videoUrl: '/videos/cosmic_bloom.webm' },
  { title: 'Grid Wave', category: 'Social Ad', audience: 'Lifestyle & Social', type: 'Reel', orientation: 'portrait', duration: '0:15', result: '4.7% CTR on paid social', thumbnail: '/images/thumb_grid_wave.jpg', videoUrl: '/videos/grid_wave.webm' },
  { title: 'Fire', category: 'Commercial', audience: 'Ads & Commercial', type: 'Widescreen', orientation: 'landscape', duration: '0:30', result: 'National TV & pre-roll spot', thumbnail: '/images/thumb_fire.jpg', videoUrl: '/videos/fire.webm' },
  { title: 'Chromatic', category: 'Reel', audience: 'Lifestyle & Social', type: 'Reel', orientation: 'portrait', duration: '0:22', result: '820K organic views', thumbnail: '/images/thumb_chromatic.jpg', videoUrl: '/videos/chromatic.webm' },
  { title: 'Speed Meteor', category: 'VFX', audience: 'Ads & Commercial', type: 'Widescreen', orientation: 'landscape', duration: '0:40', result: 'Product launch film', thumbnail: '/images/thumb_speed_meteor.jpg', videoUrl: '/videos/speed_meteor.webm' },
  { title: 'Aura', category: 'Music Video', audience: 'Music Videos', type: 'Reel', orientation: 'portrait', duration: '3:14', result: 'Official music video', thumbnail: '/images/thumb_aura.jpg', videoUrl: '/videos/aura.webm' },
  { title: 'Smoke', category: 'Brand Story', audience: 'Brand Films', type: 'Widescreen', orientation: 'landscape', duration: '2:05', result: 'Founder brand story', thumbnail: '/images/thumb_smoke.jpg', videoUrl: '/videos/smoke.webm' },
];
